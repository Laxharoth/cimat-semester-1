...
void solucion_triangular_inf( mymtx::matrix &matriz, mymtx::vector &incognitas, mymtx::vector &result,bool);
void solucion_triangular_inf( mymtx::matrix &matriz, mymtx::vector &incognitas, mymtx::vector &result);
void solucion_triangular_sup( mymtx::matrix &matriz, mymtx::vector &incognitas, mymtx::vector &result,bool);
...
void power_iteration(const mymtx::matrix &A, mymtx::vector &V1, const double tolerance, double &value, size_t n_values, mymtx::matrix *_vec_holder, mymtx::vector *_val_holder,const size_t max_iter);
void inverse_power_iteration(const mymtx::matrix &A, mymtx::vector &V1, const double tolerance, double &value, size_t n_values, mymtx::matrix *_vec_holder, mymtx::vector *_val_holder, const size_t);
...
void conjugate_gradient(const mymtx::matrix &A, mymtx::vector &var, mymtx::vector &result);
void conjugate_gradient_jacobi(const mymtx::matrix &A, mymtx::vector &var, mymtx::vector &result);

//factorizacion

void crout(mymtx::matrix &matriz, mymtx::matrix &matriz_inferior, mymtx::matrix &matriz_superior);
void crout_as_band(mymtx::matrix &A_mtx, mymtx::matrix &L_mtx, mymtx::matrix &U_mtx,int height, int width);
void crout_tridiagonal(mymtx::matrix &matriz, mymtx::matrix &matriz_inferior, mymtx::matrix &matriz_superior);
void doolittle(mymtx::matrix &matriz, mymtx::matrix &matriz_inferior, mymtx::matrix &matriz_superior);
void doolittle_as_band(mymtx::matrix &A_mtx, mymtx::matrix &L_mtx, mymtx::matrix &U_mtx,int height, int width);
void doolittle_tridiagonal(mymtx::matrix &matriz, mymtx::matrix &matriz_inferior, mymtx::matrix &matriz_superior);
void LDU_factor(mymtx::matrix &matriz, mymtx::matrix &matriz_inferior, mymtx::matrix &matriz_diagonal, mymtx::matrix &matriz_superior);
void LDU_factor_tridiagonal(mymtx::matrix &matriz, mymtx::matrix &matriz_inferior, mymtx::matrix &matriz_diagonal, mymtx::matrix &matriz_superior);
void factor_cholesky(const mymtx::matrix &matix, mymtx::matrix &triangular);
void factor_cholesky_as_band(const mymtx::matrix &matix, mymtx::matrix &triangular, int heigh);

...
int main(int argc, char const *argv[]) {
  ...
  measure_time(factor_cholesky_tridiag(m10, m10);
  ...
  measure_time(factor_cholesky_tridiag(m50, m50);
  ...
  measure_time(factor_cholesky_tridiag(m100, m100);
  ...
  measure_time(factor_cholesky_tridiag(m1000, m1000);
  ...
  measure_time(factor_cholesky_tridiag(m10000, m10000);

...
void analize_single_var_function( double (*func)(const double x), const double left, const double right ,double &min_y, double &max_y, std::array<point, PARTITIONS_NUM> &points ){
    min_y = DBL_MAX;
    max_y = -min_y;

...
class CanvasFacade{
    // El valor en pixeles donde se encuentra el origen despues de aplicar las escalas
    point origin;
    public:
    ...
    /**
     * @brief Dibuja una linea entre el point_1 y point_2 solo si point_1 y point_2 no son nan
     * 
...
/**
 * @brief Obtiene la escala para que una linea que va desde un valor a otro quepa en un espacio especifico
 * 

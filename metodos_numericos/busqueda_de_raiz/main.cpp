...
void run_test(FunctionWrapper *func, const char *, double lim_inf,
              double lim_sup, double x_init);
void run_test_Newton(FunctionWrapper *func, double x_init, int iteraciones,
...
void run_test(FunctionWrapper *func, const char *fn_str, double lim_inf,
              double lim_sup, double x_init) {
  double res{};
  double error{};
  int iteraciones{};
  ...
  std::cout << "intervalo inicial:"
            << "[" << lim_inf << "," << lim_sup << "]" << std::endl;
  std::cout << "valores iniciales:"
            << "(" << func->eval(lim_inf) << "," << func->eval(lim_sup) << ")"
            << std::endl;

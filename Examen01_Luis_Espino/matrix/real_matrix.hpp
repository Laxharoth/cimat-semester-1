...
namespace mymtx{
    ...
    class matrix{
        ...
        static matrix tridiag(const size_t n, double (*low)(const int i), double (*dig)(const int i), double (*up)(const int i));
        static matrix tridiag(const size_t n, const double low, const double dig, const double up);
        static matrix pendiag(const size_t n, const double coef[5]);
        matrix &prod_as_band(const double coef, const size_t height, const size_t width);
        vector prod_as_band(vector &vec , const size_t height, const size_t width) const;
        matrix prod_as_band(const matrix &other, const size_t height, const size_t width);
